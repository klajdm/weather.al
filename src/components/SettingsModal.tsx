        ...
        <div className="space-y-6 py-4 max-h-[50vh] sm:max-h-[60vh] overflow-y-auto px-1">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex gap-3">
                <Button
                  onClick={() => setLocalSettings({ ...localSettings, units: { temperature: 'celsius' } })}
                ...
                <Button
                  onClick={() => setLocalSettings({ ...localSettings, units: { temperature: 'fahrenheit' } })}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select which additional weather information to display</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <input
                      type="checkbox"
                      checked={localSettings.weatherData[item.key as keyof typeof localSettings.weatherData]}
                      onChange={(e) =>
                        setLocalSettings({
                          ...localSettings,
                          weatherData: { ...localSettings.weatherData, [item.key]: e.target.checked },
                        })
                      }
